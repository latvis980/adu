...
"""
Archidatum Custom Scraper - Visual AI Approach with Statistics
...
7. Click link to get publication date using AI (not regex)
8. AI filtering for content quality
9. Generate statistics report and upload to R2
...
class ArchidatumScraper(BaseCustomScraper):
    ...
    async def _find_headline_in_html_with_ai(self, page, headline: str) -> Optional[dict]:
        ...
        html_context = await page.evaluate("""
            () => {
                ...
                containers.forEach((container, index) => {
                    ...
                    // Get the main link (usually the largest)
                    let mainLink = null;
                    let mainLinkText = '';
                    ...
                    if (!mainLink || mainLinkText.length <= 5) return;
        ...
        # Format for AI (show first 15 to keep prompt manageable)
        context_text = "\n\n".join([
        ...
        prompt = f"""You are analyzing article containers from archidatum.com to find which one matches a target headline.
...
2. Context clues (URL patterns, descriptions)
...
Do not include any explanation."""
    ...
    async def fetch_articles(self, hours: int = 24) -> list[dict]:
        ...
        try:
            ...
            # Set extra headers for anti-bot protection
            ...
            try:
                ...
                for i, headline in enumerate(new_headlines, 1):
                    ...
                    try:
                        # ============================================
                        # Find headline and link with AI
                        # ============================================
                        ...
                        if not published:
                            ...
                            # DATE FILTERING: Check article age
...
async def test_archidatum_scraper():
    """Test the visual AI scraper with statistics."""
    print("=" * 60)
    print("Testing Archidatum Visual AI Scraper")
    print("=" * 60)
    ...
    try:
        ...
        stats = await scraper.tracker.get_stats(source_id="archidatum")
...
if __name__ == "__main__":
    import asyncio
    asyncio.run(test_archidatum_scraper())