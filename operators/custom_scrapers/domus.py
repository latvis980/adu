...
"""
Domus Custom Scraper - Visual AI Approach with Statistics
...
class DomusScraper(BaseCustomScraper):
    ...
    # 14 days = better for testing, Italian magazine posts moderately
    ...
    async def _find_headline_in_html_with_ai(self, page, headline: str) -> Optional[dict]:
        ...
        context_text = "Looking for headline: '{headline}'\n\nArticle containers found on page:\n"
...
async def test_domus_scraper():
    ...
    print("=" * 60)
    print("Testing Domus Visual AI Scraper")
    print("=" * 60)
